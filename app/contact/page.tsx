          ...
          <div className="space-y-8">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-900 dark:text-white">contact@anwarayub.com</p>
                  </div>
                </div>
                <div className="flex items-center space-x-4">
                  <div className="w-10 h-10 bg-blue-100 dark:bg-blue-900 rounded-full flex items-center justify-center">
            ...
            <div>
              ...
              <div className="flex space-x-4">
                ...
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm4.441 16.892c-2.102.144-1.051.144-3.153 0 0 0 1.005-.82 1.794-2.336 0 0-.45.204-1.5.204s-1.5-.204-1.5-.204c.789 1.516 1.794 2.336 1.794 2.336-2.102.144-1.051.144-3.153 0-4.294-1.431-3.345-6.44-3.345-6.44s1.311 1.6 1.799 1.6c.488 0 1.799-1.6 1.799-1.6s.051 5.009-3.294 6.44c-2.102.144-1.051.144-3.153 0 0 0 1.005-.82 1.794-2.336 0 0-.45.204-1.5.204s-1.5-.204-1.5-.204c.789 1.516 1.794 2.336 1.794 2.336-2.102.144-1.051.144-3.153 0-4.294-1.431-3.345-6.44-3.345-6.44s1.311 1.6 1.799 1.6c.488 0 1.799-1.6 1.799-1.6s.051 5.009-3.294 6.44c-2.102.144-1.051.144-3.153 0 0 0 1.005-.82 1.794-2.336 0 0-.45.204-1.5.204s-1.5-.204-1.5-.204c.789 1.516 1.794 2.336 1.794 2.336-2.102.144-1.051.144-3.153 0 0 0 2.55-8.549 2.55-8.549s2.55 8.549 2.55 8.549z" />
                  </svg>
                </a>
              </div>
            </div>
